...
public class Springboot2JpaCrudExampleApplication {
	...
	/*@Bean()
	 public InitializingBean sendDatabase() {
		return () -> {
			employeeRepository.save(new Employee("John","Papa","John.papa@gmail.com","2012-04-04","India","Karnataka","Bangalore"));
			employeeRepository.save(new Employee("Rambo","Lars","rambo.lars@gmail.com","2014-06-06","India","Telangana","Warangal"));
			employeeRepository.save(new Employee("bamboo","tree","bamboo.tree@gmail.com","2021-01-01","India","Telangana","Hyderabad"));
			employeeRepository.save(new Employee("bob","marley","bob.marley@gmail.com","2020-12-31","India","Telangana","Khammam"));
		};
	}*/
